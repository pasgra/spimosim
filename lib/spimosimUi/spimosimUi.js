...
self.spimosimUi = (function () {
  ...
  function initMenuGui() {
    ...
    var inputMemory = graphicTools.createSetting({
      ...
      value: localStorage.getItem('spimosim-memory') || (50 << 20).toString(),
...
//not .dygraph-title
  ...
  MultiSeriesTimePlotDisplay.prototype.getDeducedPlotTypes = function () {
    return {
      'multi series mean value': spimosimCore.modules.get("PlotDisplay", "multi series mean value"),
      'multi series distribution': spimosimCore.modules.get("PlotDisplay", "multi series distribution"),
      'multi series cumulated': spimosimCore.modules.get("PlotDisplay", "multi series cumulated"),
      'multi series auto correlation': spimosimCore.modules.get("PlotDisplay", "multi series auto correlation")
    };
  };
