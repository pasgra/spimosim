...
window.spimosimCreator = (function() {
  var ALL_LIBS = {
    spimosim: {
      ...
      files: [
        ...
        'lib/spimosimCore/spimosimCore.plot.worker.js',
        'lib/spimosimCore/protocol-vars.js',
        'lib/spimosimCore/LICENSE.txt',
        'lib/spimosimCore/spimosimCore.fit.worker.js',
  ...
  Creator.prototype.initGui = function (divConfig, divPreview) {
    ...
    var divVideo = cE('div');
    divVideo.classList.add('settings');
    divVideo.classList.add('code-settings');
    divConfig.appendChild(divVideo);
    ...
    var configVideo = graphicTools.createSettings({
      ...
      varNames: {
        ...
        type: 'text',
        parent: 'createDrawModes',
        parentValue: [ 'custom canvas', 'int map', 'grey scale spins', 'weighted spins' ],
        syncURI: true
      },
      minValues: {
  ...
  var STATE_VAR_SOURCE_FILES = {
    ...
    Float32: [ 'typed.js' ],
    Float64: [ 'typed.js' ],
    Int8Array: [ 'typed-array.js' ],
    Uint8Array: [ 'typed-array.js' ],
    Int16Array: [ 'typed-array.js' ],
    Uint16Array: [ 'typed-array.js' ],
    Int32Array: [ 'typed-array.js' ],
    Uint32Array: [ 'typed-array.js' ],
    Int64Array: [ 'typed-array.js' ],
    Uint64Array: [ 'typed-array.js'] ,
    Float32Array: [ 'typed-array.js' ],
    Float64Array: [ 'typed-array.js' ],
    SpinArray: [ 'typed-array.js', 'spin-array.js' ]
  };

  var NETWORK_SOURCE_FILES = {
    '1d-lattice': '1d-lattice.js',
    'dynamic-directed': 'dynamic-directed.js',
    'random undirected': 'random-undirected.js',
    'nd-lattice': 'nd-lattice.js',
    'moore-2d-lattice': 'moore2d-lattice.js',
    'moore-quadratic': 'moore-quadratic.js',
    '2d-lattice': '2d-lattice.js',
    'quadratic': 'quadratic.js',
    'barabasi-albert': 'barabasi-albert.js',
    'barabasi-albert-lattice-vis': 'barabasi-albert-lattice-vis.js',
    'moore-quadratic': 'moore-quadratic.js',
    'spimosim': 'spimosim.js'
  }
  ...
  Creator.prototype.updateModuleLibs = function() {
    ...
    for (var i = 0, len = this.domCache.configStateVars.numberOfStateVars.getValue(); i < len; i++) {
      ...
      var list = STATE_VAR_SOURCE_FILES[type];
      for (var j = 0, len2 = list.length; j < len2; j++) {
        files['../../modules/ProtocolVar/' + list[j]] = true;
      }
    }
    
    if (this.domCache.configGeneral.enableNetworkLib.getValue()) {
      filesList.push('../../spimosimNetwork/networkCore.js');
      ...
      for (var name in this.domCache.configNetwork) {
        if (this.domCache.configNetwork.hasOwnProperty(name)) {
          if (this.domCache.configNetwork[name].getValue()) {
            files['../../modules/Network/' + NETWORK_SOURCE_FILES[name]] = true;
          }
        }
      }
    }
  ...
  Creator.prototype.parseConfig = function (forDownload) {
    ...
    var config = {
      ...
      plotter: {
        ...
        backend: {
          type: 'webworker',
          workerUrl: '../../lib/spimosimCore/spimosimCore.plot.worker.js',
          urls: []
        },
        plotTypes: []
      },
  ...
  Creator.prototype.getIndexHTML = function (config) {
    ...
    if (this.domCache.configGeneral.enableNetworkLib.getValue()) {
      scriptsHTML +=
        ...
        '  <script src="../lib/spimosimNetwork/network-config.js"></script>\n' +
        '  <script src="../lib/spimosimNetwork/network-ui-config.js"></script>\n' +
        '  <script src="../lib/spimosimNetwork/var-initializers.js"></script>\n' +
        '  <script src="../lib/spimosimNetwork/video.js"></script>\n' +
        '  <script>spimosimNetwork.MAX_NODES = 65536</script>\n';
    }

    scriptsHTML += '\n' +
      '  <script src="../lib/spimosimUi/darkThemeSwitch.js"></script>\n' +
