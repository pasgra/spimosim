...
window.spimosimCreator = (function() {
  ...
  Creator.prototype.getNeededFiles = function(withUi, withFinalFileName) {
    ...
    if (withUi) {
      ...
      dependencies["module:DataAggregator/diff-int"] = true;
      dependencies["module:DataAggregator/fir-iir"] = true;
      ...
      dependencies["module:PlotDisplay/diff-int"] = true;
      dependencies["module:PlotDisplay/fir-iir"] = true;
