...
(function () {
  ...
  spimosimCore.modules.add('ControlsAddOn', 'network', NetworkUi);
  
  spimosimCore.modules.newRegister('NetworkUi');

  spimosimCore.modules.add('SettingsPreprocessor', 'NetworkUi', function (oldModelSettings, newModelSettings) {
