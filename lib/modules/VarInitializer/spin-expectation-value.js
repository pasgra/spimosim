...
(function () {
  ...
  SpinExpectationValueVarInitializer.protocolVarType = 'spin-array';
  ...
  spimosimCore.modules.add('VarInitializer', 'spin expectation value', SpinExpectationValueVarInitializer);
}());
