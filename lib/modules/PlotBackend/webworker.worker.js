...
spimosimCore.TimePlotComputer = (function () {
  ...
  TimePlotComputer.prototype.calcDataInterval = function (vars, tStart, tEnd, saveSteps) {
...
spimosimCore.MultiSeriesTimePlotComputer = (function () {
  ...
  MultiSeriesTimePlotComputer.prototype.calcDataInterval =
      function (vars, tStart, tEnd, saveSteps) {
    this.dataY = [];
    for (var i = 0; i < this.n; i++) {
...
spimosimCore.PlotWorker = (function () {
  ...
  PlotWorker.prototype.calcSteps = function (vars, tStart, tEnd) {
    ...
    var worker = this;
    function saveSteps() {
      worker.saveSteps(startTime, tStart, tEnd);
    }

    if (!this.plotComputer.calcDataInterval(vars, tStart, tEnd, saveSteps)) {
      saveSteps();
    }
  }

  PlotWorker.prototype.saveSteps = function (startTime, tStart, tEnd) {
