...
spimosimCore.modules.add('HelpTextGenerator', {
    name: 'research group short',
    files: [ 'lib/modules/HelpTextGenerator/ResearchGroupShort.js' ],
    depends: [],
    version: '1.0',
    author: 'Pascal Grafe',
    description: 'A help text generator for a short text.',
    date: '2020-03-26'
  }, function (iconUrl) {
