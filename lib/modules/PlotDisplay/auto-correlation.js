...
(function () {
  ...
  AutoCorrelationPlotDisplay.prototype.draw = function (clock) {
    switch (this.drawMode) {
      case 'histogram':
        ...
        break;
      default:
        spimosimUi.MultiSeriesTimePlotDisplay.prototype.setT.call(this, clock);
        break;
    }
  };
  ...
  AutoCorrelationPlotDisplay.prototype.setTFit = spimosimUi.TimePlotDisplay.prototype.setT;
  
  spimosimCore.modules.add('PlotDisplay', 'auto correlation', AutoCorrelationPlotDisplay);
})();
