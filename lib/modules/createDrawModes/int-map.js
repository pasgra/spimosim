...
(function () {
  ...
  var intMap = function (config, colorSet) {
    var drawModes = [],
  ...
  spimosimCore.modules.add('createDrawModes', {
    name: 'int map',
    files: [ 'lib/modules/createDrawModes/int-map.js' ],
    depends: [],
    version: '1.0',
    author: 'Pascal Grafe',
    description: 'A draw mode for integers represented by different colors.',
    date: '2020-03-26'
  }, intMap);
}());
