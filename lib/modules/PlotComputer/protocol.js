...
(function () {
  function ProtocolDataAggregator(plotter, settings) {
    tools.EventDispatcher.call(this, [ 'new data' ]);
    tools.EventAttacher.call(this);
  ...
  spimosimCore.modules.add('DataAggregator', 'protocol', spimosimCore.ProtocolDataAggregator);
})();
