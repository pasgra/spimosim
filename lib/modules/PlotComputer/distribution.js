...
(function () {
  ...
  spimosimCore.modules.add('PlotComputer', 'distribution', DistributionPlotComputer);
  spimosimCore.modules.add('PlotComputer', 'multi series distribution', DistributionPlotComputer);
}());
