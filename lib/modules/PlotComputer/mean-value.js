...
(function () {
  ...
  spimosimCore.modules.add('PlotComputer', 'mean value', MeanValuePlotComputer);
  spimosimCore.modules.add('PlotComputer', 'multi series mean value', MeanValuePlotComputer);
}());
