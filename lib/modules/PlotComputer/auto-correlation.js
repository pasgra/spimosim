...
(function () {
  ...
  spimosimCore.modules.add('PlotComputer', 'auto correlation', AutoCorrelationPlotComputer);
  spimosimCore.modules.add('PlotComputer', 'multi series auto correlation', spimosimCore.AutoCorrelationPlotComputer);
}());
