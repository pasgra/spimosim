...
spimosimCore.modules.add("ModelConfig", "Bornholdt Fixed M", {
  info: {
    title: 'Bornholdt Model with fixed Magnetisation',
    compactName: 'BornholdtFixedM',
    url: 'bornholdt_fixed_m/bornholdt_fixed_m-info.html'
  },
  controls: {
    features: [
  ...
  simulation: {
    backend: {
      ...
      urls: [
        ...
        '../../../models/bornholdt_fixed_m/bornholdt_fixed_m-model.js'
      ],
      name: 'bornholdt'
    }
  },
