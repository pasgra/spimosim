...
spimosimCore.modules.add("ModelConfig", "Bornholdt with C spins", {
  info: {
    title: 'Bornholdt Model with c Spins',
    compactName: 'BornholdtCSpins',
  ...
  simulation: {
    backend: {
      ...
      urls: [
        ...
        '../../../models/bornholdt-with-c-spins/bornholdt-with-c-spins-model.js'
      ],
      name: 'bornholdtWithCSpins'
    }
  },
  plotter: {
    features: true,
